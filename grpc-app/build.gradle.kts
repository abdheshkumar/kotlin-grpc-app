...
dependencies {
    ...
    implementation("io.ktor:ktor-server-jvm:3.2.0")
    implementation("io.ktor:ktor-server-netty-jvm:3.2.0")
    implementation("io.ktor:ktor-serialization:3.2.0")
    implementation("io.ktor:ktor-serialization-kotlinx-json-jvm:3.2.0")
    implementation("io.ktor:ktor-server-metrics-micrometer-jvm:3.2.0")
